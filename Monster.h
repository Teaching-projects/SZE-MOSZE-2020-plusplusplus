...
public:
     ...
     */
    explicit Monster(const std::string &name, unsigned short maxHp, Damage damage, double attackCooldown, unsigned short defense) : Unit(name, maxHp, damage, attackCooldown, defense){};
